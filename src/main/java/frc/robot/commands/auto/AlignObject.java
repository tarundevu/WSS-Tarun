...
public class AlignObject extends CommandBase{
    ...
    public AlignObject(double x, double y){
       
        centerX = x;
        centerY = y;
        // targetW = -m_vision.getLine(2);
        //double[] coord = m_vision.getObjectCoord();
        // targetX = (coord[0] - centerX);
        // targetY = -(coord[1] - centerY);
    }
    public AlignObject(){
        // When Width = 300
        //centerX = 155.0;
    ...
    public void execute()
    {
        ...
        //     if (((line[0] - centerX)) <1 && -(line[1] - centerY) < 1 &&-line[2]<0.05 && count >= 300) {
